...
from flaskblog.forms import RegistrationForm, LoginForm, ProjectForm, GrantForm, UpdateAccountForm, PostForm
...
def project():
    form = ProjectForm()
    if form.validate_on_submit():
        flash(f'Project {form.project_title.data} was created!', 'success')
