...
class ProjectForm(FlaskForm):  
    ...
    application = SelectField('Application :', choices=[('For_research', 'For research'),('For_diagnosis', 'For diagnosis')])
    clinical_service = SelectField('Saint-Louis clinical services', choices=[('Immunologie-Histocompatibilité','Immunologie-Histocompatibilité'),
                                                                             ('Hématologie','Hématologie'),
                                                                             ('Bactériologie','Bactériologie'),
                                                                             ('Parasitologie','Parasitologie'),
                                                                             ('Virologie','Virologie'),
                                                                             ('Génétique neurovasculaire','Génétique neurovasculaire'),
                                                                             ('Génétique des tumeurs et pharmacologie','Génétique des tumeurs et pharmacologie'),
                                                                             ('Diagnostic biologique automatisé - Biochimie','Diagnostic biologique automatisé - Biochimie')])
    # REQUIRED
