...
Revision ID: 70868fdd7e09
Revises: 07058905406b
Create Date: 2023-06-07 11:42:27.820111
...
revision = '70868fdd7e09'
down_revision = '07058905406b'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('funding_type', sa.String(length=20), nullable=False),
    ...
    sa.Column('project_token', sa.String(length=120), nullable=True),
    ...
    sa.Column('data_available', sa.String(length=20), nullable=True),
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('project_context'),
    sa.UniqueConstraint('project_summary'),
